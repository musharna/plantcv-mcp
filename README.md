...
- **Start** — [Install](#install) · [Configure your MCP client](#configure-your-mcp-client) · [Tools](#tools)
- **Measuring one RGB image** — [Segmenting](#segmenting) · [What it measures](#what-it-measures) · [Real-world units](#real-world-units) · [Getting the polarity right](#getting-the-polarity-right) · [Refining a mask](#refining-a-mask) · [Colour correction](#colour-correction)
- **Beyond one plant** — [Measuring a tray](#measuring-a-tray) · [Morphology](#morphology-leaves-stem-branch-points) · [Measuring many images](#measuring-many-images)
- **Other sensors** — [Hyperspectral and thermal](#hyperspectral-and-thermal)
- **Reference** — [Warnings and refusals](#warnings-and-refusals)
- **Operating it** — [Crash containment](#crash-containment-the-analysis-worker) · [Restricting what the server may read](#restricting-what-the-server-may-read) · [Security and trust boundary](#security-and-trust-boundary) · [Limitations](#limitations)
- [Attribution and licensing](#attribution-and-licensing) · [More](#more)
...
object — the `multi_specimen` warning at the top of this page. `measure_regions(session_id,
